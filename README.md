...
| Name | Version |
|------|---------|
| <a name="provider_yandex"></a> [yandex](#provider\_yandex) | >= 0.98 |
...
|------|-------------|------|---------|:--------:|
| <a name="input_cluster_assign_public_ip"></a> [cluster\_assign\_public\_ip](#input\_cluster\_assign\_public\_ip) | Determines whether each broker will be assigned a public IP address. The default is false | `bool` | `null` | no |
| <a name="input_cluster_brokers_count"></a> [cluster\_brokers\_count](#input\_cluster\_brokers\_count) | Count of brokers per availability zone. The default is 1 | `number` | `null` | no |
...
| <a name="input_cluster_schema_registry"></a> [cluster\_schema\_registry](#input\_cluster\_schema\_registry) | Enables managed schema registry on cluster. The default is false | `bool` | `null` | no |
...
| <a name="input_cluster_unmanaged_topics"></a> [cluster\_unmanaged\_topics](#input\_cluster\_unmanaged\_topics) | Allows to use Kafka AdminAPI to manage topics. The default is false | `bool` | `null` | no |
...
| <a name="input_labels"></a> [labels](#input\_labels) | A set of key/value label pairs to assign to the Kubernetes cluster resources | `map(any)` | `null` | no |
